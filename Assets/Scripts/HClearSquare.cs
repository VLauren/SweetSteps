...
public class HClearSquare : Square
{
    ...
    public override IEnumerator Press()
    {
        ...
        foreach (var sq in squares)
        {
            ...
            if (Mathf.Abs(sq.transform.position.z - transform.position.z) <= 0.1f && sq.GetType() != typeof(AreaSquare) && sq.GetType() != typeof(HClearSquare) && sq.GetType() != typeof(VClearSquare))
            {
